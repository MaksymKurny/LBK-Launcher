    ...
    return (
      <div className="glass-card">
        ...
        <a
          ...
          className="flex items-center gap-2 px-4 py-3 rounded-lg bg-gradient-to-r from-color-accent/20 to-color-main/20 border border-accent/30 hover:border-accent/60 transition-all duration-300 text-white hover:shadow-[0_0_20px_rgba(0,242,255,0.3)]"
        >
